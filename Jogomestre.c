...
int main () {
    ...
    int soma1, soma2;
    soma1 = populacao + aKm2 + pib + pontosTuristicos + dp + pibc;
    soma2 = populacao2 + aKm2_2 + pib_2 + pontosTuristicos2 + dp2 + pibc2;
    ...
    switch (escolha){
        case 1:
            printf("%s -- %s\n", cidade, cidade2);
            printf("Soma carta 1 vs Carta 2: %d--%d\n", soma1, soma2);
            if (soma1 == soma2){
                printf("Empate\n");
            } else if (soma1 > soma2){
